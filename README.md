...
1. **Dashboard**: Visualización general del estado del sistema
2. **AssetManager**: Crear y gestionar activos
3. **CertificateManager**: Emitir, renovar y revocar certificaciones
